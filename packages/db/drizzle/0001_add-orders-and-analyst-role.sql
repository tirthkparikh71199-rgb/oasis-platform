CREATE TYPE "public"."order_status" AS ENUM('NEW', 'CONFIRMED', 'IN_PROGRESS', 'SHIPPED', 'DELIVERED', 'CANCELLED');--> statement-breakpoint
ALTER TYPE "public"."role" ADD VALUE 'ANALYST' BEFORE 'INVENTORY_MANAGER';--> statement-breakpoint
CREATE TABLE "orders" (
